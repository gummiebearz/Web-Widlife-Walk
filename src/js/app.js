...
function start() {
	...
	// Connect the search form for location
	...
	searchForm.onsubmit = function (event) {
		...
		// Grab the value from the search form
		const searchVal = document.querySelector('#location').value;
		console.log('Search location requested: ', searchVal);
		// Call the search() function
		search(searchVal);
	};

	// Show all observations at first after new data is loaded
	showAll();
}
